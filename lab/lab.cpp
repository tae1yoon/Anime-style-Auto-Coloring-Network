/* 
input path should be put in argv[1]
L_channel path sould be put in argv[3] with *.csv
A_channel path sould be put in argv[4] with *.csv
B_channel path sould be put in argv[5] with *.csv
*/
...
int main(int argc, char* argv[])
{
    ...
    Mat gray, edge, lab_convert, upscaled, blured_image;
    Mat tmp, edge_resized, gray_resized;
    ...
    */
    ...
    /*
    string edge_out = "canny/";
    edge_out += argv[2];
    string gray_out ="gray/";
    gray_out += argv[2];
    */
    string lab_out =""; //= "lab/";
    string L_channel,A_channel,B_channel;
    ...
    L_channel = lab_out + argv[2];
    A_channel = lab_out + argv[3];
    B_channel = lab_out + argv[4];
    
    imwrite(L_channel, lab_channels[0]);
    imwrite(A_channel, lab_channels[1]);
    imwrite(B_channel, lab_channels[2]);
